<?php
    ...
    $Cupom = $_POST['txtCupom'];
    try {
        $sqlL = "SELECT Cod_cupom FROM Cupom WHERE Nome_cupom LIKE '%$Cupom%'";
    ...
    try {
        $sql = "INSERT INTO usa (fk_Cliente_Cod_Cliente, fk_Cupom_Cod_cupom) VALUES ($_Cliente, $_Cupom)";
